...
\fancyhead[C]{Sesión 6: Proyecto práctico (Hito 2)}
\fancyhead[R]{UCLM}
\fancyfoot[C]{\thepage}
...
También se amplía el sistema de equipamiento. Además del arma, el personaje podrá equipar armaduras de tres tipos: cabeza, cuerpo y pies (por ejemplo, casco, coraza y botas; se deberá utilizar un \texttt{enum}). Cada pieza de equipo (arma o armadura) podrá aportar un bonus de ataque y/o de defensa. Para modelar esta relación se deberá utilizar una interfaz que represente el contrato del equipamiento, de modo que el personaje pueda tratar de forma uniforme el arma y las armaduras mediante polimorfismo.

En concreto, el personaje deberá almacenar su equipo en un único array de tamaño fijo de 4 posiciones, cuyo tipo sea el de la interfaz. Así, la interfaz deberá definir por contrato que todo objeto equipable proporcione funciones que devuelvan el bonus de ataque y de defensa que aporta.
...
\textbf{Ejemplo (\texttt{personajes.txt}):}
...
PERSONAJE;Bran;95
EQUIPO;VACIO;ARMA
EQUIPO;ARMADURA;CascoCuero;18;1;CABEZA;2
EQUIPO;VACIO;CUERPO
EQUIPO;ARMADURA;BotasCuero;15;1;PIES;1
INV;METAL;LingoteBronce;30;3;5;68;Br
FIN
\end{Verbatim}
...
\textbf{Ejemplo (\texttt{tienda.txt}):}
\begin{Verbatim}[frame=single, fontsize=\small]
