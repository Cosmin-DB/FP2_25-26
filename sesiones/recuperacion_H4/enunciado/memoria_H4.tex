...
\fancyhead[C]{Hito 4: Proyecto práctico (convocatoria extraordinaria)}
\fancyhead[R]{UCLM}
\fancyfoot[C]{\thepage}
...
\begin{titlepage}
    ...
    {\Huge \textbf{Hito 4:}} \\
    \vspace{0.5cm}
    {\Huge \textbf{Proyecto práctico - Convocatoria extraordinaria}} \\
...
\begin{itemize}
    ...
    \item Ampliar el sistema desarrollado teniendo en cuenta el peso de los objetos.
