...
\begin{itemize}
    \item \texttt{PesoMaximoSuperadoException}: se producirá cuando se intente añadir o mover un objeto al inventario de un personaje y con ello se supere el peso máximo permitido.
\end{itemize}
